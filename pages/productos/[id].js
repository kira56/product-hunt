...
const Producto = () => {
    ...
    const votarProducto = () => {
        ...
        guardarConsultarDB(true); // Hay un voto consultar base de datos
    ...
    const agregarComentario = (e) => {
        ...
        // Informacion extra al formulario
        comentario.usuarioId = usuario.uid;
        comentario.usuarioNombre = usuario.displayName;
        ...
        guardarConsultarDB(true); // Hay un comentario consultar base de datos
